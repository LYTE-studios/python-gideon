    ...
    async def ask_chatgpt(self, message: str, bot_names=None, history=None, persona="assistant", channel_name="") -> str:
        ...
        if persona == "developer":
            ...
            sys_prompt = (
                ...
                "This includes actual requests (info, advice, help), like 'How are you doing Gideon?', 'Hey assistant!', 'Are you there, Gideon?', '<@your_id> what's up?', or any direct call for your attention like 'hey Gideon, please answer'. "
                "If a user asks for help, attention, an answer, or directs a question to you in any real form, you MUST answer. "
                "However, DO NOT reply to jokes, banter, memes, or non-serious comments even if your name is mentioned. "
                "Do NOT reply to friendly banter or conversations between users, or attempts at humor involving your name, unless there is a genuine question or request for help directed to you."
                "Do not respond to conversations between other users, unless specifically called by name or mentioned, and the message is a real help request."
