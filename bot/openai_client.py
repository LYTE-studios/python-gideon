    ...
    async def ask_chatgpt(self, message: str, bot_names=None, history=None, persona="assistant", channel_name="") -> str:
        ...
        if persona == "developer":
            ...
            sys_prompt = (
                ...
                f"Your recognized names and aliases are: {names_str}. ""If the user is asking to schedule/plan a meeting, event, or reminder, respond ONLY in this strict format—replace fields, do NOT add any commentary or explanation, do NOT answer outside this format:"
                "\n[SCHEDULE_EVENT]\n"
                "{\n  \"title\": \"...\","
                "\n  \"description\": \"...\","
                "\n  \"participants\": [\"...\"],"
