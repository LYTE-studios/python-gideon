...
class OpenAIClient:
    ...
    async def ask_chatgpt(self, message: str, bot_names=None, history=None) -> str:
        ...
        sys_prompt = (
            ...
            "If the user's message includes your name or alias in a greeting ('How are you doing, Gideon?', 'Hey assistant!'), or is obviously chatty or friendly and addressed to you, you MAY answer. "
