...
class OpenAIClient:
    ...
    async def ask_chatgpt(self, message: str, bot_names=None) -> str:
        ...
        sys_prompt = (
            ...
            "You must ONLY reply if the message clearly, specifically addresses you—by your Discord username, display name, a direct @mention/tag, or using one of your aliases or 'assistant'. "
            "If there is any ambiguity, or you are not 100% certain you are being addressed, reply exactly and ONLY with 'NO_REPLY'. "
